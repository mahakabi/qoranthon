...
export default function Timeline() {
  ...
  const events = [
    { date: "١ يونيو", status: "فتح باب التسجيل" },
    { date: "١٥ يونيو", status: "إغلاق فترة التسجيل" },
    {
      date: "١٦ يونيو",
      status: "مراجعة الطلبات والأفكار المقدمة من المشاركين",
    },
    {
      date: "١٧ يونيو",
      status: "إرسال رسائل القبول وتأكيد الحضور من المشاركين",
    },
    { date: "١٩ يونيو", status: "اللقاء التمهيدي - آياتثون الانطلاقة" },
    { date: "٢٦ يونيو", status: "بداية الهاكاثون" },
    { date: "٢٨ يونيو", status: "الحفل الختامي وإعلان النتائج" },
  ];
