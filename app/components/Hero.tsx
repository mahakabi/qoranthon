...
const Hero = () => {
    const [timeLeft, setTimeLeft] = useState(getTimeRemaining(new Date("2025-02-20T00:00:00").getTime()));

    useEffect(() => {
        const interval = setInterval(() => {
            setTimeLeft(getTimeRemaining(new Date("2025-02-20T00:00:00").getTime()));
        }, 1000);
            ...
            <div className="relative z-10 flex flex-col items-center px-4">
                ...
                >
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center bg-white/20 backdrop-blur rounded-md px-2 py-2 shadow-md min-w-[50px]">
                            <span className="text-sm md:text-2xl ">{item.value.toString().padStart(2, '0')}</span>
